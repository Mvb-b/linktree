...
```json
{
  ...
  "data": {
    ...
    "topLinks": [
      { "platform": "twitch", "url": "https://twitch.tv/misrravb", "count": 80 }
    ]
  }
}
```
...
function MyButton() {
  ...
  const handleClick = () => {
    trackClick('facebook', 'https://facebook.com/misrravb')
    window.open('https://facebook.com/misrravb', '_blank')
  }
...
Accede al dashboard en: `https://dev-linktree.misrravb.com/admin/analytics`
...
### Ubicación
```
/data/workspace/projects/misrravb-linktree/data/analytics.db
```
