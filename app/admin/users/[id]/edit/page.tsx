        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            ...
            <input
              ...
              className="w-full px-4 py-3 rounded-lg bg-white/5 border border-white/10 text-white placeholder-gray-500 focus:outline-none focus:border-fire-orange/50 transition-colors"
              placeholder="juan@streamerhub.com"
              required
            />
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div>
              ...
              {isSelf && (
                <p className="text-gray-500 text-xs mt-1">No puedes desactivar tu propia cuenta</p>
              )}
            </div>
          </div>
...
export default function EditUserPage() {
  return (
    <Suspense fallback={
      <div className="flex items-center justify-center h-64">
        <div className="w-12 h-12 border-4 border-fire-orange/30 border-t-fire-orange rounded-full animate-spin"></div>
      </div>
    }>
      <EditUserContent />
    </Suspense>
