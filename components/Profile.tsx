...
export function Profile({ name, bio, subtitle }: ProfileProps) {
  return (
    <div className="flex flex-col items-center text-center px-4 py-6">
      {/* Avatar placeholder */}
      <div className="relative mb-4">
        <div className="w-28 h-28 md:w-32 md:h-32 glass-card rounded-full flex items-center justify-center">
